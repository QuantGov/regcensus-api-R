...
#' @return A string detailing how long it takes to read a document based on how many words the document has. The function assumes an 8 hour work-day, a 5 day work-week, and a 50 week work-year.
#' @examples
...
reading_time <- function(words, workday=8, workweek=5, workyear=50) {
  ...
  if (as.integer(minutes) > 0 & as.integer(years) == 0 & as.integer(weeks) == 0) {
